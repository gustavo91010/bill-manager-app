...
export default function Dashboard() {
  ...
  useEffect(() => {
    const loadExpenses = async () => {
      ...
      console.log("getPayments retornou:", data)
      setExpenses(data)
    }
          ...
          <main className="flex-1 space-y-6 p-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <Card className="border-blue-100 bg-blue-50">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-blue-700">R$ {mockSummary.totalDue.toFixed(2)}</div>
                </CardContent>
              </Card>
              <Card className="border-green-100 bg-green-50">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-green-700">R$ {mockSummary.amountPaid.toFixed(2)}</div>
                </CardContent>
              </Card>
              <Card className="border-red-100 bg-red-50">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-red-700">R$ {mockSummary.remaining.toFixed(2)}</div>
                </CardContent>
              </Card>
            </div>
...
// // const mockExpenses = await getPayments()
// // const mockExpenses = [{ "date": "04 de junho", "expenses": [{ "id": 7, "name": "Sem descrição", "amount": 198.13, "category": "Sem categoria", "status": "em_dias" }] }]

// const mockExpenses = [
//   {
//     date: "20 de Maio",
//     expenses: [
//       { id: 1, name: "Aluguel", amount: 850, category: "Moradia", status: "pendente" },
//       { id: 2, name: "Internet", amount: 75.99, category: "Utilidades", status: "pendente" },
//     ],
//   },
//   {
//     date: "25 de Maio",
//     expenses: [
//       { id: 3, name: "Conta de Luz", amount: 120.5, category: "Utilidades", status: "pendente" },
//       { id: 4, name: "Conta de Água", amount: 45.75, category: "Utilidades", status: "pendente" },
//       { id: 5, name: "Conta de Celular", amount: 85.99, category: "Utilidades", status: "pago" },
//     ],
//   },
//   {
//     date: "1 de Junho",
//     expenses: [
//       { id: 6, name: "Seguro do Carro", amount: 125.5, category: "Seguro", status: "pendente" },
//       { id: 7, name: "Academia", amount: 49.99, category: "Saúde", status: "pendente" },
//     ],
//   },
// ]
...
//                 {/* parece qye aqyu é onde ele da o get pagamenos */}

//                 <div className="space-y-4">
//                   {mockExpenses.map((dateGroup) => (
//                     <Card key={dateGroup.date} className="border-gray-200">
//                       <CardHeader className="cursor-pointer py-3" onClick={() => toggleDateExpansion(dateGroup.date)}>
//                         <div className="flex items-center justify-between">
//                           <CardTitle>{dateGroup.date}</CardTitle>
...
//                       onMonthChange={(date) => {
//                         console.log("Mês alterado:", date)
//                         // Aqui você pode chamar a função getPayments(date) ou qualquer outra lógica
//                       }}
//                     />
//                   </CardContent>
//                 </Card>
